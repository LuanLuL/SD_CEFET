...
public class ServidorTCP {
    public void execute(int qtdClients) {
        try {
            ServerSocket server = new ServerSocket(3322);

            JOptionPane.showMessageDialog(
                null,
                "ServidorTCP::execute() Servidor iniciado na porta 3322"
            );
            ...
            for (int i = 0; i < qtdClients; i++) {
                ...
                String msg = JOptionPane.showInputDialog(
                    "Servidor::execute(): Olá, você está conectado ao servidor"
                );
                ...
                JOptionPane.showMessageDialog(
                    null,
                    "ServidorTCP::execute(): " + reader.readUTF()
                );
            ...
            JOptionPane.showMessageDialog(
                null,
                "ServidorTCP::execute() " + error.getMessage()
            );
        }
    }
}
